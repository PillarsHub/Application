...
import { CanWrite, AccessTypes } from '../../features/authentication/hooks/useToken.jsx';
          ...
          <div className="col-3 d-none d-md-block border-end">
            <div className="card-body">
              ...
              <div className="list-group list-group-transparent">
                ...
                {CanWrite(AccessTypes.SourceGroups) &&
                ...
                {CanWrite(AccessTypes.Customers) &&
              ...
              <div className="list-group list-group-transparent">
                {CanWrite(AccessTypes.Inventory) &&
